...
const isWSL = __nccwpck_require__(948);
const termux = __nccwpck_require__(796);
const linux = __nccwpck_require__(590);
const macos = __nccwpck_require__(736);
const windows = __nccwpck_require__(25);
...
const execa = __nccwpck_require__(895);

const xsel = 'xsel';
const xselFallback = __nccwpck_require__.ab + "xsel";
...
const xselWithFallback = async (argumentList, options) => {
	try {
		...
		try {
			return await execa.stdout(__nccwpck_require__.ab + "xsel", argumentList, options);
		} catch (fallbackError) {
...
const xselWithFallbackSync = (argumentList, options) => {
	try {
		...
		try {
			return execa.sync(__nccwpck_require__.ab + "xsel", argumentList, options);
		} catch (fallbackError) {
			throw makeError(xselError, fallbackError);
		}
	}
...
const path = __nccwpck_require__(622);
const execa = __nccwpck_require__(895);
const arch = __nccwpck_require__(603);

// Binaries from: https://github.com/sindresorhus/win-clipboard
const windowBinaryPath = arch() === 'x64' ? __nccwpck_require__.ab + "clipboard_x86_64.exe" : __nccwpck_require__.ab + "clipboard_i686.exe";
...
const parse = __nccwpck_require__(579);
...
const path = __nccwpck_require__(622);
const niceTry = __nccwpck_require__(676);
const resolveCommand = __nccwpck_require__(785);
const escape = __nccwpck_require__(881);
const readShebang = __nccwpck_require__(979);
const semver = __nccwpck_require__(669);
...
const shebangCommand = __nccwpck_require__(507);
...
const path = __nccwpck_require__(622);
const which = __nccwpck_require__(711);
const pathKey = __nccwpck_require__(335)();
...
var once = __nccwpck_require__(526);
...
const crossSpawn = __nccwpck_require__(790);
const stripEof = __nccwpck_require__(649);
const npmRunPath = __nccwpck_require__(249);
const isStream = __nccwpck_require__(555);
const _getStream = __nccwpck_require__(295);
const pFinally = __nccwpck_require__(134);
const onExit = __nccwpck_require__(685);
const errname = __nccwpck_require__(299);
const stdio = __nccwpck_require__(212);
...
const pump = __nccwpck_require__(967);
...
const fs = __nccwpck_require__(747);
const isDocker = __nccwpck_require__(871);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(264)
} else {
  core = __nccwpck_require__(449)
}
...
var wrappy = __nccwpck_require__(7)
...
var once = __nccwpck_require__(526)
var eos = __nccwpck_require__(407)
...
var shebangRegex = __nccwpck_require__(122);
...
var signals = __nccwpck_require__(280)
...
var path = __nccwpck_require__(622)
var COLON = isWindows ? ';' : ':'
var isexe = __nccwpck_require__(363)
...
var readline = __importStar(__nccwpck_require__(58));
var clipboardy = __importStar(__nccwpck_require__(719));
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(981);
